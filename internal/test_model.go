...
// DefaultTasks stores the dummy data generated by
// create-tables.sql file. This data will be used
// in tests (Repository, ORM, API, ...)
...
// TestCRUD function is reused in both Repository
// and ORM tests
